 ...
 */
public class ApplePayAuthorizeRequest extends AbstractAuthorizeRequest {
     ...
     */
    public ApplePayAuthorizeRequest(String paymentToken,  String ipAddress, String reconciliationId, String emailAddress, String paymentInstrumentName, String paymentNetwork, String transactionIdentifier, String data, String applicationData, String ephemeralPublicKey, String publicKeyHash, String transactionId, String signature, String version) {
        super(paymentToken, ipAddress, new PaymentMethod(PaymentMethodType.ApplePayEncrypted, paymentInstrumentName, paymentNetwork, transactionIdentifier, data, applicationData, ephemeralPublicKey, publicKeyHash, transactionId, signature, version), reconciliationId, emailAddress);
    }
     ...
     */
    public ApplePayAuthorizeRequest(String paymentToken, String ipAddress, String reconciliationId, String emailAddress, String paymentInstrumentName, String paymentNetwork, String transactionIdentifier, String applicationPrimaryAccountNumber,
        ...
        super(paymentToken, ipAddress, new PaymentMethod(PaymentMethodType.ApplePay, paymentInstrumentName, paymentNetwork, transactionIdentifier, applicationPrimaryAccountNumber, applicationExpirationDate,
                currencyCode, transactionAmount, cardholderName, deviceManufacturerIdentifier, paymentDataType, onlinePaymentCryptogram, eciIndicator), reconciliationId, emailAddress);
    }
